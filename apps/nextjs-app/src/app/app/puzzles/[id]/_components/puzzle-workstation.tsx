        ...
        <div className="flex flex-wrap items-center gap-4 rounded-xl border border-border/60 bg-card/80 px-4 py-2.5 text-[13px] text-foreground shadow-subtle backdrop-blur-sm">
          <div className="flex items-center gap-1">
            ...
            <InfoPopup>
              ...
              {creatorBudget != null && creatorBudget > 0 && (
                <p className="mt-1"><span className="font-medium text-foreground">Creator&apos;s cost</span> — The cost of the creator&apos;s own solution. Beat it to earn a better medal.</p>
              )}
