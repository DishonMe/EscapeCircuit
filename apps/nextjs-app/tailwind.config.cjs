  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'modal': '0 8px 30px rgb(0 0 0 / 0.12), 0 2px 8px rgb(0 0 0 / 0.06)',
      },
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
        ...
        'accent-pop': {
          '0%':   { color: '#f0f4ff', transform: 'scale(0.95)' },
          '60%':  { transform: 'scale(1.06)' },
          '100%': { color: '#63b3ed', transform: 'scale(1)' },
        },
      },
      animation: {
        ...
        'accent-pop': 'accent-pop 0.8s ease-out both',
      },
    },
  },
