...
class TestSolveAttemptCreation:
    ...
    def test_create_solve_attempt_missing_puzzle_id(self):
        with pytest.raises(TypeError):
            SolveAttempt(id=1, user_id=1)

    def test_create_solve_attempt_missing_user_id(self):
        with pytest.raises(TypeError):
            SolveAttempt(id=1, puzzle_id=1)
...
class TestSolveAttemptSubmission:
    def test_mark_submitted_pass(self):
        ...
        assert attempt.passed is None
        attempt.mark_submitted(passed=True, circuit_id="c1")
    ...
    def test_mark_submitted_updates_circuit(self):
        ...
        attempt.mark_submitted(passed=True, circuit_id="c2")
...
class TestSolveAttemptBranches:
    ...
    def test_elapsed_seconds_positive(self):
        ...
        now = datetime.now(timezone.utc)
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1, started_at=now)
    ...
    def test_mark_submitted_preserves_circuit_id(self):
        ...
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1, circuit_id="c1")
    ...
    def test_set_passed_none(self):
        ...
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1, passed=True)
    ...
    def test_set_fail_reason_none(self):
        ...
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1, fail_reason="timeout")
...
class TestSolveAttemptGetters:
    ...
    def test_get_id(self):
        attempt = SolveAttempt(id=77, puzzle_id=1, user_id=1)
        assert attempt.get_id() == 77
    
    def test_get_puzzle_id(self):
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1)
        assert attempt.get_puzzle_id() == 1
    
    def test_get_user_id(self):
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1)
        assert attempt.get_user_id() == 1
    
    def test_get_circuit_id_none(self):
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1, circuit_id=None)
        assert attempt.get_circuit_id() is None
    
    def test_get_circuit_id_value(self):
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1, circuit_id=1)
        assert attempt.get_circuit_id() == 1
    ...
    def test_get_submitted_at_none(self):
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1, submitted_at=None)
        assert attempt.get_submitted_at() is None
    
    def test_get_submitted_at_value(self):
        now = datetime.now(timezone.utc)
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1, submitted_at=now)
        assert attempt.get_submitted_at() == now
    
    def test_get_passed_none(self):
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1, passed=None)
    ...
    def test_get_passed_false(self):
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1, passed=False)
        assert attempt.get_passed() is False
    
    def test_get_fail_reason_none(self):
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1, fail_reason=None)
...
class TestSolveAttemptSetters:
    ...
    def test_set_puzzle_id(self):
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1)
        attempt.set_puzzle_id(2)
        assert attempt.puzzle_id == 2
    ...
    def test_set_user_id(self):
        attempt = SolveAttempt(id=1, puzzle_id=1, user_id=1)
        attempt.set_user_id(2)
        assert attempt.user_id == 2
